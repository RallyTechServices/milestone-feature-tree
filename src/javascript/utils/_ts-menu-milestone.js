 ...
 */
Ext.define('CArABU.technicalservices.MilestoneMenu', {
    extend: 'Rally.ui.menu.RecordMenu',
    alias: 'widget.tsmilestonerecordmenu',
    ...
    _getMenuItems: function() {
        ...
        record.isPortfolioItem = function() { return false; };
        record.isMilestone = function() { return true; };
